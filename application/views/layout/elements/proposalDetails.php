...
<?php foreach ($getCapstoneDetails as $key => $getCapstoneDetail): ?>
    ...
    <?php if ($getCapstoneDetail->status !=3 ): ?>
        <div class="col-md-12">
            <a class="btn btn-sm btn-danger btn-rejectProsalByHead" href="" groupid="<?php echo $getCapstoneDetail->thesis_group_id ?>" thesisId="<?php echo $getCapstoneDetail->id; ?>" >Reject</a>
