...
<script src="<?php echo base_url('assets/sai/js/widget.js') ?>"></script>

<script>
	var base_url = '<?php echo base_url() ?>';
	var studentId = '<?php echo $userInfo->id ?>';
    var botmanWidget = {
        frameEndpoint: `${base_url}sai/messenger/index`,
        introMessage: 'Hi !  Please Enter the "Start Conversation" to start the conversation',
        chatServer : `${base_url}sai/chatbotController/bot`, 
        title: 'SAI'
    }; 
	
	// - remove autocomplete in chatbot
	$("#userText").attr("autocomplete","off");
</script>
