            ...
            <div class="col-md-12">
                <div class="card-hover-shadow-2x mb-3 card">
                    <div class="card-body" style="border: 2px solid black;">
                        <form class="" id="formProjectHearing" action="index.html" method="post">
                            ...
                            <p style="margin-bottom: 0pt;">
                                <span style="font-family: 'Arial'; font-size: 12pt; font-weight: bold;">February 7, 2020 (8:00 AM) </span>
                            </p>
                            <p style="margin-bottom: 0pt;">
                    ...
                    <div class="d-block text-right card-footer">
                        ...
                        <button class="mr-2 btn btn-outline-danger btn-sm">Cancel</button>
                    </div>
                </div>
            </div>
