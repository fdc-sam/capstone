                ...
                <div class="card mb-3">
                    <div class="card-body">
						<form id="form-addMoreProjectHearing" class=""
                            action="<?php echo base_url('instructor/panel/assignedGroupReject/'.$projectTitleHearingId.'/'.$groupId); ?>" method="post">
							<div class="form-row">
								<div class="col-md-12">
                            ...
                            <div class="clearfix">
                                ...
                                <a href="<?php echo base_url('instructor/panel'); ?>" class="btn-shadow float-right btn-wide mr-3 btn btn-outline-secondary">Cancel</a>
                            </div>
						</form>
                    </div>
                </div>
