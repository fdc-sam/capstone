...
class Auth extends CI_Controller
{
	...
	public function create_activation_code($len){
		$result = "";
	...
	public function create_user(){
		...
		if (
			...
			$message .= "<tr><td><strong>Your Email:</strong> </td><td>" . $this->input->post('email') . "</td></tr>";
			$message .= "<tr><td><strong>Your Password:</strong> </td><td>" . $this->input->post('password') . "</td></tr>";
